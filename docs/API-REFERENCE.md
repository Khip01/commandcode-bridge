...
| `/v1/models` | GET | List available models (live API merged with bundled). Expired models (no longer provided by Command Code) are hidden; newly released live models appear immediately |
